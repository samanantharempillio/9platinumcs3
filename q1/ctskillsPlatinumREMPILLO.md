...
| ------------------------------------------------ | ------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Managing the student queue                       | Decomposition + Algorithm Design      | Break the queue into steps:  1. add student 2. assign queue number 3. serve the first student  4. remove the student after their order is completed.                  |
